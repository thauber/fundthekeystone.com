  ...
  return (
    <div className="modal">
      ...
      <div className="modal-content">
        ...
        <p className="mb-4 font-sans">Every donation makes a difference, but you can also amplify your donation by spreading the word!</p>
        <div className="flex w-full flex-grow items-center  text-cool bg-bright rounded-md py-2 pr-6">
          <div className="pl-6 flex-grow">
            Share
          </div>
          <div className="font-sans text-sm uppercase">Amplify Your Donation</div>
        </div>
