...
export default function Document() {
  return (
    <Html lang="en" className="snap-y snap-proximity md:snap-mandatory snap-always overflow-scroll-y" >
      <Head>
      ...
      <body className="snap-y snap-proximity md:snap-mandatory snap-always" >
        <Main />
        <NextScript />
      </body>
    </Html>
